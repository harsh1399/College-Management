...
from college_info.models import User,Course,Batch,Teaches,Student,Dept,Staff,Assignment,PeriodTime,Attendance,BatchAttendance,AttendanceTotal,StudentCourse,MarksClass,Marks,Submission
